...
Route::group(['prefix' => 'v0', 'namespace' => '\App\Api\Controllers'], function () {
    ...
    Route::middleware(['can:global-read'])->group(function () {
        ...
        Route::get('services/{hostname}', 'LegacyApiController@list_services');
    ...
    Route::group(['prefix' => 'devices'], function () {
        ...
        Route::get('{hostname}/links', 'LegacyApiController@list_links');
        ...
        Route::get('{hostname}/groups', 'LegacyApiController@get_device_groups');
